...
const Contacts: React.FC = () => {
  ...
  return (
    <div className="p-4">
      <h2 className="text-2xl font-bold mb-2 text-center">Contact Page</h2>

      {/* Create Contact Form */}
      <div className="mt-8 text-center">
        <button
          className="text-lg font-bold bg-blue-500 text-white px-4 py-2 rounded"
          onClick={openModal}
        >
          Create Contact
        </button>
      ...
      <div className="flex justify-center align-center">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-16 p-20">
          {contacts.length === 0 ? (
              ...
              >
                <div className="text-center">
                  <p className="text-xl font-semibold mb-2">
                    Name: <span className="font-semibold text-blue-600">{contact.firstName} {contact.lastName}</span>
                  </p>
                  <p className="text-l font-semibold mb-2">Status: <span className="font-semibold text-green-800">{contact.status}</span></p>
                  <div className="mt-2">
                    <button
